...
router.get('/trails/:trailId/reminders/:reminderId', HttpRequestHandlers.getAReminder);
router.delete('/trails/:trailId/reminders/:reminderId', HttpRequestHandlers.deleteReminder);
